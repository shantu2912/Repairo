...
async function submitTechnician(state) {
    ...
    try {
        // Insert technician - tech_id will be auto-generated by database trigger
        ...
        .insert([{
            ...
            area: area,
            status: 'pending'
            // tech_id will be automatically added by the database trigger
        }]);

        if (error) throw error;
        state.isSuccess = true;

        // Optional: Fetch the newly created technician with tech_id
        ...
        if (data) {
            console.log(`✅ Technician registered with ID: ${data.tech_id}`);
        }
